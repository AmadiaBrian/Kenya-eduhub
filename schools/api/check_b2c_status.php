<?php
// Check B2C Withdrawal Status for Schools
...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM school_withdrawals WHERE id = ? AND school_id = ? LIMIT 1");
    $stmt->execute([$withdrawal_id, $_SESSION['school_id']]);
