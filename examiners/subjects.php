<?php
// Subjects Management Page for Examiners
...
<head>
    ...
    <title>Subjects - <?php echo htmlspecialchars($examiner_name); ?></title>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-folder me-2"></i>Subject Categories
                </div>
                <div class="card-body">
                    ...
                    <h5 class="card-title">Add Single Category</h5>
                    <form method="POST">
                        <div class="row mb-3">
                            <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-list me-2"></i>Current Categories
                </div>
                <div class="card-body">
                ...
                <div class="modal-body">
                    <form id="addSubjectForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="subjectCategory">
