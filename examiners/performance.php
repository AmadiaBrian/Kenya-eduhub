<?php
// Performance Tracking Page for Examiners
...
<head>
    ...
    <title>Performance - <?php echo htmlspecialchars($examiner_name); ?></title>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="quick-access-grid">
                        ...
                        <a href="subjects" class="quick-access-item">
                            <div class="quick-access-icon">
                                <i class="fas fa-book"></i>
                            </div>
                            <div class="quick-access-label">Subjects</div>
                        </a>
                        <a href="exam-types" class="quick-access-item">
                            <div class="quick-access-icon">
                                <i class="fas fa-clipboard-list"></i>
                            </div>
                            <div class="quick-access-label">Exam Types</div>
                        </a>
                    </div>
                </div>
            </div>
