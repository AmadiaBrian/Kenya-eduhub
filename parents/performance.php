    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="card">
            ...
            <div style="display: flex; gap: 16px;">
                <a href="performance.php?view=children" class="btn <?php echo $view_mode === 'children' ? 'btn-primary' : 'btn-outline'; ?>">
                    <i class="fas fa-child"></i> My Children's Results
                </a>
                <a href="performance.php?view=class" class="btn <?php echo $view_mode === 'class' ? 'btn-primary' : 'btn-outline'; ?>">
