...
<body>
    ...
    <script>
        ...
        document.getElementById('invoiceForm').addEventListener('submit', function(e) {
            ...
            console.log('Generating invoices for class:', classId, 'term:', term, 'year:', year);
            ...
            fetch('../schools/api/invoice_generation.php?action=generate_class_invoices', {
                method: 'POST',
                body: formData
            })
            .then(response => {
            ...
            .then(data => {
                console.log('Invoice generation response data:', data);
                if (data.success) {
        ...
        function printInvoice(invoiceId) {
            window.open('../schools/print_invoice.php?id=' + invoiceId, '_blank');
        }
        ...
        function deleteInvoice(invoiceId) {
            ...
            notificationSystem.confirm('Are you sure you want to delete this invoice? This action cannot be undone.', {
                ...
                if (confirmed) {
                    console.log('User confirmed deletion of invoice:', invoiceId);
                    fetch('../schools/api/invoice_generation.php?action=delete_invoice', {
                        method: 'POST',
                        headers: {
